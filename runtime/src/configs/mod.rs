...
use frame_support::{
	...
	parameter_types,
	traits::{
		AsEnsureOriginWithArg, ConstBool, ConstU32, ConstU64, ConstU8, ConstU128, EitherOfDiverse,
...
use super::{
	...
	AccountId, Assets, Aura, Balance, Balances, Block, BlockNumber, CollatorSelection, ConsensusHook,
	Council, Democracy, Hash, MessageQueue, Nonce, OriginCaller, PalletInfo, ParachainSystem,
...
parameter_types! {
	...
	// Maximum weight for council proposals
...
// 2. Configure Council (Collective)
pub type CouncilCollective = pallet_collective::Instance1;
impl pallet_collective::Config<CouncilCollective> for Runtime {
	type RuntimeOrigin = RuntimeOrigin;
	type Proposal = RuntimeCall;
	type RuntimeEvent = RuntimeEvent;
	type MotionDuration = ConstU32<100>;
...
// 3. Configure Scheduler (required by Democracy)
parameter_types! {
...
// 4. Configure Preimage (required by Democracy and Scheduler)
parameter_types! {
...
// 5. Configure Democracy
parameter_types! {
	pub const LaunchPeriod: BlockNumber = 24 * HOURS;
	pub const VotingPeriod: BlockNumber = 24 * HOURS;
